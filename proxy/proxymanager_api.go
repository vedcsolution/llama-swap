...
func addApiHandlers(pm *ProxyManager) {
	...
	apiGroup := pm.ginEngine.Group("/api", pm.apiKeyAuth())
	{
		...
		apiGroup.GET("/cluster/settings", pm.apiGetClusterSettings)
		apiGroup.PUT("/cluster/settings", pm.apiSetClusterSettings)
		apiGroup.POST("/cluster/settings/wizard", pm.apiWizardClusterSettings)
